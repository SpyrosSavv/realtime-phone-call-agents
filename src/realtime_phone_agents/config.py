...
class SuperlinkedSettings(BaseModel):
    ...
    sqft_min_value: int = Field(default=20, description="Minimum value for apartment size in square feet")
    sqft_max_value: int = Field(default=2000, description="Maximum value for apartment size in square feet")
    price_min_value: int = Field(default=100000, description="Minimum value for apartment price in euros")
    price_max_value: int = Field(default=10000000, description="Maximum value for apartment price in euros")
